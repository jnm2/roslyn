...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    {
        private readonly MethodSymbol _userModuleInitializerTriggerMethod;

        internal SynthesizedRootModuleTypeStaticConstructor(NamedTypeSymbol containingType, MethodSymbol userModuleInitializerTriggerMethod)
        {
            ContainingType = containingType;
            _userModuleInitializerTriggerMethod = userModuleInitializerTriggerMethod;
        }
            ...
            F.CloseMethod(
                F.Block(
                    F.ExpressionStatement(
                        F.StaticCall(_userModuleInitializerTriggerMethod, ImmutableArray<BoundExpression>.Empty)),
                    F.Return()));
        }
