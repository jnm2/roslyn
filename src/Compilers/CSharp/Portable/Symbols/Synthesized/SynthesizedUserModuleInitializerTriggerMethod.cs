...
{
    internal sealed class SynthesizedUserModuleInitializerTriggerMethod : MethodSymbol
    {
        public SynthesizedUserModuleInitializerTriggerMethod(NamedTypeSymbol containingType)
        {
        ...
        public override bool AreLocalsZeroed => ContainingType.AreLocalsZeroed;

        public override string Name => "<TriggerClassConstructor>";
