...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    /// cref="SynthesizedRootModuleTypeStaticConstructor.ContainingType"/> so that tests can use the proper type name
    /// for <see cref="CompilationTestData.GetMethodsByName"/>.
    /// </summary>
